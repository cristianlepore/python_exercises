...
WORDLIST_FILENAME = '/var/www/html/exercises/Lesson10/Problem1/words.txt'
...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        cyphertext = ""
        dict = self.build_shift_dict(shift).copy()
        for char in plaintext:
            try:
                cyphertext += dict.get(char)
            except TypeError:
                cyphertext += char
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        '''
        self.shift = shift
        PlaintextMessage.__init__(self, self.text, self.shift)
...
class CiphertextMessage(Message):
    def __init__(self, text):
        ...
        '''
        self.message_text = text
        Message.__init__(self, self.message_text)
