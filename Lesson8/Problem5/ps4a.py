...
def playGame(wordList):
    ...
    word = 'aa'
    word = word.lower()
    hand = {'h': 1, 'v': 1, 'n': 1, 'e': 2, 'm': 1, 'o': 1, 'y': 1, 'w': 1}
    print(calculateHandlen(hand))               # Problem 4
    if isValidWord(word, hand, wordList):       # Problem 3
        score = getWordScore(word, HAND_SIZE)   # Problem 1
        hand = updateHand(hand, word)           # Problem 2
        displayHand(hand)
    else:
